    ...
    head: () => ({
      meta: [
...

        {
          ...
          content:
            "Motion Designer and Video Editor creating engaging visual experiences through animation, motion graphics, editing and visual storytelling.",
        },
